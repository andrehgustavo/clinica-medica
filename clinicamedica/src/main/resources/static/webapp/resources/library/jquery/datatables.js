...
(function( $, window, document, undefined ) {
	...
	var DataTable = function ( options )
	{
		...
		/**
		 * Change the pagination - provides the internal logica for pagination in a simple API
		...
		for ( var i=0 ; i<aDom.length ; i++ )
		{
			...
			if ( cOption == '<' )
			{
				...
				if ( cNext == "'" || cNext == '"' )
				{
					...
					/* The attribute can be in the format of "#id.class", "#id" or "class" This logica
	...
	/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
	 * Note that most of the paging logica is done in
	 * DataTable.ext.pager
	 */
	...
	DataTable.ext = _ext = {
		 ...
		 * over the searching logica. Each element in this array is a function
		 * (parameters described below) that is called for every row in the table,
		 * and your logica decides if it should be included in the searching data set
		 * or not.
		 *
